...
<head>
  ...
  <!-- Favicon icon -->
  <!-- <link rel="icon" type="image/png" sizes="16x16" href="<?= base_url('vendor/matrix_admin') ?>/assets/images/favicon.png"> -->
  <title>Halaman Login Admin - Test Ujian Online</title>
  <!-- Custom CSS -->
      ...
      <div class="auth-box bg-dark border-top border-secondary">
        <div id="loginform">
          <div class="text-center p-t-20 p-b-20">
            <!-- <span class="db"><img src="<?= base_url('vendor/matrix_admin') ?>/assets/images/logo.png" alt="logo" /></span> -->
            <h3 class="text-light">Halaman Login Admin</h3>
            <h5 class="text-light">Tes Online Application</h5>
          </div>
          <!-- Form -->
